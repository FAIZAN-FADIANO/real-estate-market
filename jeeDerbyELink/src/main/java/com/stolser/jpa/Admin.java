 ...
 * <ul>
 * <li>User.UserType.SUPER_ADMIN - cannot be deleted and created from the Admin
 * Panel. So, in the system can be only one user with the type = SUPER_ADMIN.<br/>
 * Only this user can create/delete other users.;</li>
 * <li>User.UserType.ADMIN - access to all possible functionality on the
 * back-end excluding manipulating users.<br/>
